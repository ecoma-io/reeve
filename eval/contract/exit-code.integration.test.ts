...
// 12 triage + 11 respond + 7 harmonise + 3 translate + 3 duplicate + 4 lifecycle + 3 dependa + 8 review = 51, multilingual fixtures included.
    expect(run.out).toMatch(/finding 51 · failed 0 · skipped 0/);
  });
