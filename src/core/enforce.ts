 ...
 * file and what a maintainer has already done to the thread. Nothing it
 * consults can be written by the author of an issue, and none of it is an
 * input a workflow can widen: the `duties:` block in the warrant is the whole
 * authority, and its grants are the only permission a verdict can ever earn.
 *
 ...
 */
import { type Label, type Warrant } from "./warrant.js";
