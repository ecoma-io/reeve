...
const CHROME = {
  ...
  translateBoundary: {
    ...
    vi: "**Văn bản phía trên là bản gốc, và đây là phiên bản mà dự án này chịu trách nhiệm.** Mọi nội dung phía dưới là bản dịch máy bởi [Reeve](https://github.com/ecoma-io/reeve). Nếu có sự khác biệt, văn bản phía trên mới là văn bản có giá trị.",
  },
  translateFooterFrom: {
  ...
  lifecycleFooterEscape: {
    ...
    vi: "Thêm nhãn `{label}` sẽ dừng vĩnh viễn.",
  },
  ...
  respondBoundaryDrafted: {
    ...
    vi: "Phản hồi này được soạn bởi [Reeve](https://github.com/ecoma-io/reeve), không phải bởi một maintainer.",
  },
  respondBoundaryCaveat: {
    en: "A maintainer has not reviewed it. Treat it as a starting point, not an answer.",
    vi: "Một maintainer chưa xem xét phản hồi này. Hãy xem đây là điểm khởi đầu, không phải câu trả lời cuối cùng.",
  },
  ...
  respondFooterRecord: {
    ...
    vi: "Reeve chỉ trả lời một chủ đề một lần. Bình luận này là bằng chứng cho điều đó.",
  },
  ...
  duplicateFooterFloor: {
    ...
    vi: "Được đề xuất bởi một model, không phải quyết định của maintainer — hãy xem đây là một manh mối cần kiểm tra.",
  },
...
export function chromeFallbackNote(codes: readonly (string | null)[]): string | null {
  ...
  return (
    ...
    `instead. Configured: ${CHROME_LANGUAGES.join(", ")}.`
  );
}
