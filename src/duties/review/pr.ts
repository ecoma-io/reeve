...
/** Whether a path looks machine-generated by suffix — see `rules.ts`'s `generated.extensions`. */
export function isGenerated(path: string, extensions: readonly string[]): boolean {
