  ...
  return [
    {
      ...
      content: [
        ...
        "- `confidence`: how far this whole answer can be relied on, from 0 to 1. One number for",
        "  the entire review — never one per finding. Judge it and state it yourself: weigh how",
        "  much of the diff you actually read against how sure you are of what you are reporting.",
        "  An empty `findings` list is not a reason to answer low — a diff you read in full and",
        "  found clean is a confident all-clear. Answer low when you could not read enough of the",
        "  diff to stand behind either an all-clear or the findings you did report. The number",
        "  above shows the shape only: it is not a default, and copying it is not judging.",
